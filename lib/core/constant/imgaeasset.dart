class AppImageAsset {
  ...
  static const String logoSvg = "$rootImages/logo.svg";
  ...
  static const String deliveryImage = "$rootImages/logo.png";
  static const String deliveryImageTow = "$rootImages/logo.png";
  static const String deliveryImageThree = "$rootImages/logo.png";
