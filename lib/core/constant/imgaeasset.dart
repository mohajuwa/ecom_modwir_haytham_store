class AppImageAsset {
  ...
  static const String laptopImg = "$rootImages/laptop.png";
  ...
  static const String loginAuthImg = "$rootImages/up/phoneAuth.png";
  ...
  static const String deliveryImage = "$rootImages/006-delivery.png";
  static const String deliveryImageTow = "$rootImages/005-delivery-man.png";
  static const String deliveryImageThree = "$rootImages/002-delivery-truck.png";
