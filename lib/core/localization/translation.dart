...
class MyTranslation extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        "ar": {
          ...
          "confirm": "تأكيد",
          "alert": "تنبيه ...!",
          "give_permission_to_app": " الرجاء إعطاء صلاحية  الموقع للتطبيق ",
          "please_turn_on_location": "الرجاء تشغيل خدمات الموفع...",
          "should_use_location": "لا يمكن استعمال البرنامج من دون خدمات الموقع",
          "error": "خطأ",
          "year": "سنة الصنع",
          ...
          "addressess": "العناوين",
          "add_details_address": "اضافة تفاصيل العنوان",
          ...
          "offer_not_available": "العرض غير متوفر حاليًا",
          "offer_valid_until": "صالح حتى {date}",
          "pay_when_receiving": "الدفع عند الاستلام",
          "no_additional_fees": "لا توجد رسوم إضافية",
          "pay_later": "الدفع لاحقًا",
          "secure_online_payment": "الدفع الإلكتروني الآمن",
          "secure_transaction": "معاملة آمنة",
          ...
          "uploading_attachments": "جارِ رفع الملحقات...",
          "add_new_vehicle": "اضافة مركبة جديدة",
          ...
          "tap_to_select_time": "اضغط لاختيار الوقت",
          "select_date_first": "اختر التاريخ أولاً",
          "scheduled_for": "مجدول لـ",
          "at_time": "في",
          "schedule_required": "الجدولة مطلوبة",
          "please_select_date_and_time":
              "يرجى اختيار التاريخ والوقت للطلب المجدول",
          "invalid_schedule": "جدولة غير صحيحة",
          "scheduled_time_must_be_future":
              "يجب أن يكون الوقت المجدول في المستقبل",
          "unknown_date": "تاريخ غير معروف",
          "unknown_type": "نوع غير معروف",
          "cash_on_delivery_short": "د.ع",
          "card_payment_short": "بطاقة",
          "unknown_payment": "دفع غير معروف",
          "cancel_order_short": "إلغاء",
          "track_order_short": "تتبع",
          "rate_order_short": "تقييم",
          "view_details_short": "تفاصيل",
          ...
          "no_approved_orders": "لا توجد طلبات موافق عليها",
          "no_scheduled_orders": "لا توجد طلبات مجدولة",
          "no_orders_on_the_way": "لا توجد طلبات في الطريق",
          "no_delivered_orders": "لا توجد طلبات تم تسليمها",
          "no_orders_found": "لم يتم العثور على طلبات",
          "clear_filters_sort": "مسح الفلاتر والترتيب",
          "search_orders_hint": "ابحث برقم الطلب، العنوان، ملاحظات...",
          "sort_by": "ترتيب حسب",
          "date_newest": "التاريخ (الأحدث أولاً)",
          "date_oldest": "التاريخ (الأقدم أولاً)",
          "total_high_low": "الإجمالي (من الأعلى للأقل)",
          "total_low_high": "الإجمالي (من الأقل للأعلى)",
          "no_search_results_orders": "لا توجد نتائج بحث تطابق طلبك",
          "rating_submitted_successfully": "تم إرسال التقييم بنجاح",
          "failed_to_submit_rating": "فشل إرسال التقييم",
        },
        ...
        "en": {
          ...
          "remove": "Remove",
          "alert": "Alert ..!",
          "give_permission_to_app": "Please give permission to app",
          "please_turn_on_location": "Please turn on location",
          "should_use_location": "App should use location",
          "error": "Error",
          "year": "Year Made in",
          "confirm": "Confirm",
          ...
          "addressess": "Address",
          "add_details_address": "Add  address details ",
          ...
          "order_canceled_successfully": "Canceled Orders",
          ...
          "delivery_fee_definded": "After order complated",
          ...
          "offer_valid_until": "Valid until {date}",
          "pay_when_receiving": "Pay when receiving",
          ...
          "cash_on_delivery_short": "COD",
          "card_payment_short": "Card",
          "unknown_payment": "Unknown Payment",
          "cancel_order_short": "Cancel",
          "track_order_short": "Track",
          "rate_order_short": "Rate",
          ...
          "no_approved_orders": "No approved orders",
          "no_scheduled_orders": "No scheduled orders",
          "no_orders_on_the_way": "No orders on the way",
          "no_delivered_orders": "No delivered orders",
          "no_orders_found": "No orders found",
          "clear_filters_sort": "Clear filters & sort",
          "search_orders_hint": "Search by number, address, notes...",
          "sort_by": "Sort by",
          ...
          "no_search_results_orders": "No orders match your search",
